...
const CopySection = () => {
  return (
    <>
      {/* Section 1 */}
      <section className="bg-gradient-to-br from-pink-500 to-pink-900 rounded-xl text-white flex flex-col lg:flex-row items-center justify-between gap-6 my-10 px-20 mx-10 py-16">
